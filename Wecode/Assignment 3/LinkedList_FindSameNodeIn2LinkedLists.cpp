...
/***********************************************************************************/
    ...
    while (current1 != current2) {
        if (current1 == nullptr) {
            current1 = head2;  // If end of list1 is reached, start from head2
        } 
        else {
        ...
        if (current2 == nullptr) {
            current2 = head1;  // If end of list2 is reached, start from head1
        } 
        else {
    ...
    return current1;  // Return the common node (or nullptr if none found)
